...
public class _fileStub extends org.omg.CORBA.portable.ObjectImpl implements filebox.file
{
  ...
  public org.omg.CORBA.Any contentbinary ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_contentbinary", true);
                $in = _invoke ($out);
  ...
  public void contentbinary (org.omg.CORBA.Any newContentbinary)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_contentbinary", true);
                $out.write_any (newContentbinary);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
