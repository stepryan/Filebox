 ...
 implements filebox.serviceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getFiles", new java.lang.Integer (5));
    _methods.put ("changeFileStatus", new java.lang.Integer (6));
    _methods.put ("fileUpdate", new java.lang.Integer (7));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // filebox/service/getFiles
       {
         int userid = in.read_long ();
         filebox.file $result[] = null;
         $result = this.getFiles (userid);
         out = $rh.createReply();
         filebox.filesHelper.write (out, $result);
         break;
       }

       case 6:  // filebox/service/changeFileStatus
       {
       ...
       case 7:  // filebox/service/fileUpdate
       {
         String filelist = in.read_string ();
