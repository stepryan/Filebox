 ...
 implements filebox.fileOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_uid", new java.lang.Integer (8));
    _methods.put ("_set_uid", new java.lang.Integer (9));
    _methods.put ("register", new java.lang.Integer (10));
    _methods.put ("addFile", new java.lang.Integer (11));
    _methods.put ("changeFileStatus", new java.lang.Integer (12));
    _methods.put ("fileUpdate", new java.lang.Integer (13));
    _methods.put ("getFiles", new java.lang.Integer (14));
    _methods.put ("getFile", new java.lang.Integer (15));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 12:  // filebox/file/changeFileStatus
       {
       ...
       case 13:  // filebox/file/fileUpdate
       {
         String filelist = in.read_string ();
