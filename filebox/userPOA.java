 ...
 implements filebox.userOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("removeFile", new java.lang.Integer (13));
    _methods.put ("checkFileUpdates", new java.lang.Integer (14));
  }
  ...
  // 0 = public 1 = private
       case 9:  // filebox/user/addUser
       {
         ...
         $result = this.addUser (uid, username, password);
         out = $rh.createReply();
         filebox.userHelper.write (out, $result);
         break;
       }

       case 10:  // filebox/user/login
       {
         String username = in.read_string ();
         String password = in.read_string ();
         filebox.user $result = null;
       ...
       case 12:  // filebox/user/changeFileStatus
       {
         String files = in.read_string ();
       ...
       case 13:  // filebox/user/removeFile
       {
         String files = in.read_string ();
         filebox.user $result = null;
       ...
       case 14:  // filebox/user/checkFileUpdates
       {
         String files = in.read_string ();
